...
var require_vue_upload_component = __commonJS({
  "node_modules/vue-upload-component/dist/vue-upload-component.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory(require_vue()) : typeof define === "function" && define.amd ? define(["vue"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.VueUploadComponent = factory(global.Vue));
      ...
      function _objectSpread(target) {
        for (var i = 1; i < arguments.length; i++) {
          ...
          i % 2 ? _ownKeys(Object(source), true).forEach(function(key) {
      ...
      var createRequest = function createRequest2(options) {
      ...
      var sendRequest = function sendRequest2(xhr, body) {
      ...
      var sendFormRequest = function sendFormRequest2(xhr, data) {
      ...
      var ChunkUploadHandler = function() {
        function ChunkUploadHandler2(file, options) {
          _classCallCheck(this, ChunkUploadHandler2);
          this.file = file;
        ...
        _createClass(ChunkUploadHandler2, [{
          key: "maxRetries",
          get: function get() {
        ...
        watch: {
          ...
          modelValue: function modelValue(files) {
            ...
            for (var _key in oldMaps) {
              if (!this.maps[_key]) {
                this.emitFile(void 0, oldMaps[_key]);
              }
            }
          }
        },
        methods: {
          ...
          add: function add(_files, index) {
            ...
            for (var i = 0; i < files.length; i++) {
              ...
              if (this.emitFilter(file, void 0)) {
                continue;
              }
            ...
            for (var _i2 = 0; _i2 < addFiles.length; _i2++) {
              this.emitFile(addFiles[_i2], void 0);
            }
          ...
          addInputFile: function addInputFile(el) {
            ...
            var files = [];
            this.iMaximum;
            var entrys = el.webkitEntries || el.entries || void 0;
            if (entrys !== null && entrys !== void 0 && entrys.length) {
              return this.getFileSystemEntry(entrys).then(function(files2) {
                return _this8.add(files2);
              });
            }
            if (el.files) {
          ...
          addDataTransfer: function addDataTransfer(dataTransfer) {
            var _dataTransfer$items, _this9 = this;
          ...
          getFileSystemEntry: function getFileSystemEntry(entry) {
            ...
            return new Promise(function(resolve) {
              ...
              if (entry instanceof Array) {
                var uploadFiles = [];
                var forEach = function forEach2(i) {
                  var v = entry[i];
              ...
              if (entry.isDirectory && _this10.dropDirectory) {
                ...
                var readEntries = function readEntries2() {
                  dirReader.readEntries(function(entries) {
                    var forEach2 = function forEach3(i) {
          ...
          remove: function remove(id) {
            ...
            if (file) {
              if (this.emitFilter(void 0, file)) {
                return false;
              }
              var files = this.files.concat([]);
          ...
          emitFilter: function emitFilter(newFile, oldFile) {
            ...
            this.$emit("input-filter", newFile, oldFile, function() {
              var prevent = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true;
              isPrevent = prevent;
              return isPrevent;
            });
            return isPrevent;
              ...
              this.$nextTick(function() {
                setTimeout(function() {
                  newFile && _this11.upload(newFile).then(function() {
                    var _newFile2;
                    if (newFile) {
                      newFile = _this11.get(newFile) || void 0;
                    }
          ...
          upload: function upload(id) {
            ...
            if (this.size > 0 && file.size !== void 0 && file.size >= 0 && file.size > this.size) {
          ...
          uploadXhr: function uploadXhr(xhr, ufile, body) {
            ...
            xhr.upload.onprogress = function(e) {
              ...
              var speedTime2 = Math.round(Date.now() / 1e3);
          ...
          uploadHtml4: function uploadHtml4(ufile) {
            ...
            var getResponseData = function getResponseData2() {
              var _doc;
              var doc;
              try {
          ...
          watchDrop: function watchDrop(newDrop) {
            var oldDrop = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : void 0;
          ...
          inputOnChange: async function inputOnChange(e) {
            ...
            e.target;
            var reinput = function reinput2(res) {
              _this14.reload = true;
...
// dep:vue-upload-component
var vue_upload_component_default = require_vue_upload_component();
export {
  vue_upload_component_default as default
};
/*!
